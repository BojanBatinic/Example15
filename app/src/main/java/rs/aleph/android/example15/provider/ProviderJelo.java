...
public class ProviderJelo {
    ...
    public static List<Jelo> getJela() {
        ...
        jela.add(new Jelo(1, "cezar.jpg", "Cezar salata 400g", "Obrok salata od svezeg povrca i mesa", "Paradajiz, krastavac, paprika i tvrdi sir.", 210.00, 350.00, mrsnoJelo));
        jela.add(new Jelo(2, "tuna.jpg", "Tuna salata 400g", "Obrok salata od svezeg povrca i tunjevine", "Paradajiz, krastavac, paprika i tvrdi sir.", 230.00, 320.00, posnoJelo));
